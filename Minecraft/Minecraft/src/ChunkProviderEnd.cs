...
namespace net.minecraft.src
{
    public class ChunkProviderEnd : IChunkProvider
    {
        ...
        public virtual void Func_40380_a(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
        {
            byte byte0 = 2;
            int i = byte0 + 1;
            byte byte1 = 33;
        ...
        {
            endRNG.SetSeed(par1 * (int)0x4f9939f5 + par2 * (int)0x1ef1565b);
