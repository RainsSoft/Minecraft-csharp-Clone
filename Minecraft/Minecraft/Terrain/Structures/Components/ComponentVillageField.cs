...
namespace net.minecraft.src
{
	public class ComponentVillageField : ComponentVillage
	{
		...
		public ComponentVillageField(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4) : base(par1)
		{
		...
		/// </summary>
        public static ComponentVillageField FindValidPlacement(List<StructureComponent> par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
		{
